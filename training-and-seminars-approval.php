<?php
	...
	$api = new Api;
	$page_title = 'Trainings & Seminars Approval';
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-12">
                                                <table id="training-approval-datatable" class="table table-bordered align-middle mb-0 table-hover table-striped dt-responsive nowrap w-100">
                                                    <thead>
                                                        <tr>
