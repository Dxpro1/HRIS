...
# Insert/update career
    ...
    if(isset($_POST['username']) && !empty($_POST['username']) &&
       isset($_POST['position']) && !empty($_POST['position']) &&  isset($_POST['branch']) && !empty($_POST['branch']) &&
       ...
       isset($_POST['careersummary']) && !empty($_POST['careersummary'])){
        ...
        if(!empty($career_id) && $career_id !== '0' && $career_id !== 'null'){
            ...
            if($check_data_exist > 0){
                ...
                error_log("Career not found for update, ID: " . $career_id);
                echo 'Career record not found for update';
            }
        } else {
            // This is a new career insertion
            error_log("Inserting new career: " . $position);
