<?php
	...
	$page_access = $api->check_role_permissions($username, 247);
	$add_ticket = $api->check_role_permissions($username, 248);
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="float-end btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <?php
                                                            if($add_ticket > 0){
                                                                echo '<a class="dropdown-item" href="javascript: void(0);" id="add-ticket">Add Ticket</a>';
                                                            }
                                                        ?>
                                                        <a class="dropdown-item" href="javascript: void(0);" id="filter-ticket">Filter Ticket</a>
                                                        <a class="dropdown-item" href="javascript: void(0);" id="filter-ticket-by-date">Filter Ticket By Date</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                                            <div class="col-md-12">
                                                <table id="ticket-datatable" class="table table-bordered align-middle mb-0 table-hover table-striped dt-responsive nowrap w-100">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Solved Date</th>
                                                            <th>Close Date</th>
                                                            <th>Rejected/Cancellation Date</th>
