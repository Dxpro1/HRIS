<?php
    ...
    $add_role = $api->check_role_permissions($username, 2);
                                            ...
                                            <?php
                                                if($add_role > 0){
                                                    echo '<div class="col-md-6">
                                                        <div class="float-end">
                                                        <button type="button" class="btn btn-primary waves-effect btn-label waves-light" id="add-role"><i class="bx bx-plus label-icon"></i> Add Role</button>
                                                        </div>
                                                    </div>';
                                                }
                                            ?>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-12">
                                                <table id="roles-datatable" class="table table-bordered align-middle mb-0 table-hover table-striped dt-responsive nowrap w-100">
                                                    <thead>
                                                        <tr>
                                                            <th class="all" width="60%">Role</th>
                                                            <th class="all" width="20%">Role Status</th>
