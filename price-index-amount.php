<?php
	...
	$api = new Api;
	$page_title = 'Price Index Amount';

	# Check role permission
	$page_access = $api->check_role_permissions($username, 362);
    $add_price_index_amount = $api->check_role_permissions($username, 363);
    $import_price_index_amount = $api->check_role_permissions($username, 366);
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="d-flex align-items-start">
                                                <div class="flex-grow-1 align-self-center">
                                                    <h4 class="card-title">Price Index Amount Table</h4>
                                                </div>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <?php
                                                            if($add_price_index_amount > 0){
                                                                echo '<a class="dropdown-item" href="javascript: void(0);" id="add-price-index-amount">Add Price Index Amount</a>';
                                                            }

                                                            if($import_price_index_amount > 0){
                                                                echo '<a class="dropdown-item" href="javascript: void(0);" id="import-price-index-amount">Import Price Index Amount</a>';
                                                            }
                                                        ?>
                                                    </div>
                                                ...
                                                <div class="offcanvas offcanvas-end" tabindex="-1" id="filter-off-canvas" data-bs-backdrop="true" aria-labelledby="filter-off-canvas-label">
                                                    ...
                                                    <div class="offcanvas-body">
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-control filter-select2" id="filter_year">
                                                                <?php echo $api->generate_year(date('Y'), date("Y", strtotime("-15 years")), 'desc'); ?>
                                                            </select>
                                                        </div>
                                                        <div class="mb-3">
                                                        ...
                                                        <div>
                                                            <button type="button" class="btn btn-primary waves-effect waves-light" id="apply-price-index-amount-filter" data-bs-toggle="offcanvas" data-bs-target="#filter-off-canvas" aria-controls="filter-off-canvas">Apply Filter</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-12">
                                                <table id="price-index-amount-datatable" class="table table-bordered align-middle mb-0 table-hover table-striped dt-responsive nowrap w-100">
                                                    <thead>
                                                        <tr>
                                                            <th class="all" style="width:30%">Item</th>
                                                            <th class="all" style="width:10%">Year</th>
                                                            <th class="all" style="width:10%">Amount</th>
                                                            <th class="all" style="width:10%">Loanable Amount</th>
                                                            <th class="none">Created Date</th>
                                                            <th class="none">Created By</th>
                                                            <th class="none">Last Updated Date</th>
                                                            <th class="none">Last Updated By</th>
