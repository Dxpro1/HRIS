<?php
	...
	$api = new Api;
	$page_title = 'Ticket Adjustment Request';

	# Check role permission
	$page_access = $api->check_role_permissions($username, 275);
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h4 class="card-title">Ticket Adjustment Request Table</h4>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                                            <div class="col-md-12">
                                                <table id="ticket-adjustment-request-datatable" class="table table-bordered align-middle mb-0 table-hover table-striped dt-responsive nowrap w-100">
                                                    <thead>
                                                        <tr>
