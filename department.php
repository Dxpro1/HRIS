<?php
    ...
    $add_department = $api->check_role_permissions($username, 36);
                                            ...
                                            <?php
                                                if($add_department > 0){
                                                    echo '<div class="col-md-6">
                                                        <div class="float-end">
                                                        <button type="button" class="btn btn-primary waves-effect btn-label waves-light" id="add-department"><i class="bx bx-plus label-icon"></i> Add Department</button>
                                                        </div>
                                                    </div>';
                                                }
                                            ?>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-12">
                                                <table id="department-datatable" class="table table-bordered align-middle mb-0 table-hover table-striped dt-responsive nowrap w-100">
                                                    <thead>
                                                        <tr>
                                                            <th class="all" style="width:80%">Department</th>
