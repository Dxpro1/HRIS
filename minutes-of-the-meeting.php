<?php
	...
	$api = new Api;
	$page_title = 'Minutes of The Meeting';
                                                ...
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="d-flex gap-2">
                                                        <?php
                                                            if($add_meeting > 0 ){
                                                                ...
                                                                if($add_meeting > 0){
                                                                    echo '<button type="button" class="btn btn-primary waves-effect btn-label waves-light" id="add-meeting"><i class="bx bx-plus label-icon"></i> Add Meeting</button>';
                                                                }
                                                            }
                                                        ?>
                                                    ...
                                                    <div class="offcanvas offcanvas-end" tabindex="-1" id="filter-off-canvas" data-bs-backdrop="true" aria-labelledby="filter-off-canvas-label">
                                                        ...
                                                        <div class="offcanvas-body">
                                                            <div class="mb-3">
                                                                <p class="text-muted">Meeting Date</p>
                                                            ...
                                                            <div class="mb-3">
                                                                <p class="text-muted">Meeting Type</p>

                                                                <select class="form-control filter-select2" id="filter_meeting_type" name="filter_meeting_type">
                                                                    <option value="">All Meeting Type</option>
                                                                    <?php echo $api->generate_system_options('MEETINGTYPE'); ?>
                                                                </select>
                                                            </div>
                                                            <div>
                                                                <button type="button" class="btn btn-primary waves-effect waves-light" id="apply-meeting-filter" data-bs-toggle="offcanvas" data-bs-target="#filter-off-canvas" aria-controls="filter-off-canvas">Apply Filter</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
