                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h4 class="card-title">Credit Policies & Procedure Document Table</h4>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-12">
                                                <table id="publish-credit-document-datatable" class="table table-bordered align-middle mb-0 table-hover table-striped dt-responsive nowrap w-100">
                                                    <thead>
                                                        <tr>
