                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h4 class="card-title">Pending Document Table</h4>
                                            </div>
                                            <?php
                                                if($add_document > 0){
                                                    echo '<div class="col-md-6">
                                                        <div class="float-end">
                                                        <button type="button" class="btn btn-primary waves-effect btn-label waves-light" id="add-document"><i class="bx bx-plus label-icon"></i> Add Document</button>
                                                        </div>
                                                    </div>';
                                                }
                                            ?>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-12">
                                                <table id="pending-document-datatable" class="table table-bordered align-middle mb-0 table-hover table-striped dt-responsive nowrap w-100">
                                                    <thead>
                                                        <tr>
