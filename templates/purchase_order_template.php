    ...
    <div class="container">
        <table class="header-row"><tr>
            ...
            <td class="po-meta">
                ...
                <div class="meta-row" style="margin-top:6px;">
                    <span class="meta-label">Page Number</span> 1 of 1
                </div>
            </td>
        </tr></table>
        ...
        <table class="items-table" style="margin-top:18px;">
            ...
            <tbody>
                ...
                while ($line_number <= 6) { // Shorter than your old layout; adjust as needed
        ...
        <!-- Summary similar to your old format; works for both vatable & non-vatable -->
