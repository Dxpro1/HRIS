                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h4 class="card-title">System Parameter Table</h4>
                                            </div>
                                            <?php
                                                if($add_system_parameter > 0){
                                                    echo '<div class="col-md-6">
                                                        <div class="float-end">
                                                        <button type="button" class="btn btn-primary waves-effect btn-label waves-light" id="add-system-parameter"><i class="bx bx-plus label-icon"></i> Add System Parameter</button>
                                                        </div>
                                                    </div>';
                                                }
                                            ?>
