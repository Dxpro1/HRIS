                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <p class="card-title-desc" id="employee-attendance-record-filter"></p>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="float-end">
                                                    <button type="button" class="btn btn-primary waves-effect btn-label waves-light" id="filter-employee-attendance-record"><i class="bx bx-filter-alt label-icon"></i> Filter</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h4 class="card-title">Attendance Adjustment Request Table</h4>
                                                <p class="card-title-desc" id="employee-attendance-adjustment-filter"></p>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="float-end">
                                                    <button type="button" class="btn btn-primary waves-effect btn-label waves-light" id="filter-employee-attendance-adjustment"><i class="bx bx-filter-alt label-icon"></i> Filter</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                                            <div class="col-md-12">
                                                <table id="employee-attendance-adjustment-datatable" class="table table-bordered align-middle mb-0 table-hover table-striped dt-responsive nowrap w-100">
                                                    <thead>
                                                        <tr>
