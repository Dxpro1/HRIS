<?php
	...
	$page_access = $api->check_role_permissions($username, 142);
	$apply_leave = $api->check_role_permissions($username, 143);
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h4 class="card-title">Leave Application Table</h4>
                                            </div>
                                            <?php
                                                if($apply_leave > 0){
                                                    echo '<div class="col-md-6">
                                                             <div class="float-end">
                                                                <button type="button" class="btn btn-primary waves-effect btn-label waves-light" id="apply-leave"><i class="bx bx-plus label-icon"></i> Apply Leave</button>
                                                                </div>
                                                            </div>';
                                                }
                                            ?>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-12">
                                                <table id="leaves-application-datatable" class="table table-bordered align-middle mb-0 table-hover table-striped dt-responsive nowrap w-100">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="all">Available Leave</th>
