<?php
    ...
    $add_user_account = $api->check_role_permissions($username, 105);
                                            ...
                                            <?php
                                                if($add_user_account > 0){
                                                    echo '<div class="col-md-6">
                                                        <div class="float-end">
                                                        <button type="button" class="btn btn-primary waves-effect btn-label waves-light" id="add-user-account"><i class="bx bx-plus label-icon"></i> Add User Account</button>
                                                        </div>
                                                    </div>';
                                                }
                                            ?>
