<?php
	...
	$page_access = $api->check_role_permissions($username, 429);
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Career Management</a></li>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <?php
                                                if($add_career > 0){
                                                    echo '<div class="col-md-6">
                                                        <div class="float-end">
                                                        <button type="button" class="btn btn-primary waves-effect btn-label waves-light" id="add-career"><i class="bx bx-plus label-icon"></i> Add Career</button>
                                                        </div>
                                                    </div>';
                                                }
                                            ?>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-12">
                                                ...
                                                <thead>
                                                    <tr>
                                                        <th class="all" width="35%">Position21</th>
                                                        ...
                                                        <th class="none" width="10%">Order</th>
